...
const editors = [
  { name: "OpenClaw", logo: "/logos/openclaw.png", circular: false, url: "https://openclaw.io" },
  { name: "Cursor", logo: "/logos/cursor.png", circular: true, url: "https://cursor.com" },
  { name: "Claude", logo: "/logos/claude.png", circular: true, url: "https://claude.ai" },
];
          ...
          <div className="flex flex-wrap items-center gap-8">
            {editors.map((editor) => (
              <a 
                ...
                className="flex items-center gap-2.5 text-neutral-500 hover:text-neutral-700 transition-colors"
              >
                <img 
                  src={editor.logo} 
                  alt={editor.name} 
